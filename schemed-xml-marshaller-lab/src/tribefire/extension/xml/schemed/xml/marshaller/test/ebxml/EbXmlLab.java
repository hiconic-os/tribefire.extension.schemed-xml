...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.ebxml;
...
public class EbXmlLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "invoice-original.xml";
	private static final String TEST_XSD = "ebxml-6.1.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.EbXml-mapping.model.xml";
	private File contents = new File(res, "ebxml");	
