...
// ============================================================================
package tribefire.extension.xml.schemed.xml.marshaller.test.generics.typeOverride;
...
public class TypeOverrideXmlLab extends AbstractXmlMarshallerLab {
	private static final String TEST_XML = "typeOverride.xml";
	private static final String TEST_XSD = "typeOverride.xsd";
	private static final String MAPPING_MODEL_XML = "com.braintribe.xsd.TypeOverride-mapping.model.xml";
	private File contents = new File(res, "generics/typeOverride");	
